...
plt.plot(day_of_week_main_df.index, day_of_week_main_df['OCCUPANCY'], color='yellow', marker='.', label='Grand Canal Dock')
...
plt.plot(hour_main_df.index, hour_main_df['OCCUPANCY'], color='yellow', marker='.', label='Grand Canal Dock')
